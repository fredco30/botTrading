...
Cost model: LOW 0.75 / NORMAL 1.5 / STRESS 3.0 pts RT (1 pt = $5).
...
TRADES=420 | TPW=1.33 | NET=+2.99 pts (+$14.97) | PF=1.366 | EXP_R=+0.244
STRESS=+1.49 pts (PF 1.164) | REMOVE_BEST=+1.74 | MAXDD_USD_1NQ=-1211
...
TRADES=226 | TPW=0.73 | NET=+15.07 pts (+$75.36) | PF=1.284 | EXP_R=+0.069
STRESS=+13.57 (PF 1.252) | REMOVE_BEST=+4.31 | MAXDD_USD_1NQ=-6626
...
TRADES=133 | TPW=0.43 | NET=+14.31 pts (+$71.54) | PF=1.515 | EXP_R=+0.063
STRESS=+12.81 (PF 1.443) | REMOVE_BEST=+12.06 | MAXDD_USD_1NQ=-3062
