...
## Résultats (N=32, une ligne = un FOMC, 3 jambes ensemble)

| Métrique | Valeur (pips) |
|---|---|
| POOLED_GROSS | +1.51 |
| POOLED_NET_NORMAL (2p) | **−9.83** |
| POOLED_NET_STRESS (4p) | −11.83 |
| MEDIAN_NET_NORMAL | −4.53 |
| WIN_RATE_NET_NORMAL | 0.4375 |
| EURUSD / USDJPY / GBPUSD NET | −11.19 / −6.79 / −11.52 (0/3 positifs) |
| BY_YEAR_NET_NORMAL | 2019 −1.12 · 2020 −7.67 · 2021 +1.01 · 2022 −31.54 (1/4 positifs) |
| REMOVE_BEST_EVENT_NET_NORMAL | −12.61 |
| CI95 NET (paired bootstrap, 2000, seed 42) | [−24.47, +5.07] |
...
hors échantillon : en brut la continuation moyenne est +1.5 pip
(~nulle), et les coûts la rendent nettement négative.

## Fichiers

- `lib_v1.py` / `run_v1.py` — implémentation de la règle figée
- `test_v1.py` — 8 tests (timing causal, direction à T30, bornes V1,
